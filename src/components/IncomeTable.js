...
function IncomeTable({ filter }) {
  ...
  const handleEdit = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:3001/api/update/income`, {
        // Your Express route
        method: "PUT",
        headers: {
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ display: "flex", flexDirection: "row" }}>
              <div style={{ width: "100%" }}>
                ...
                >
                  <option value="essential">recurring</option>
                  <option value="non-essential">non-recurring</option>
                </select>
              </div>
              <div style={{ width: "100%" }}>
                <input
